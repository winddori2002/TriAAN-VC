...
We provide four versions of models depending on input types (mel, cpc) and dataset split (split or all).
...
In ```./samples```, they are generated by "TriAAN-VC-CPC-All". For sampels in demo site, they are generated by paper version ("TriAAN-VC-CPC-Split")
